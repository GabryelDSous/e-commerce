...
public record ProductRegisterRequest(@NotBlank(message = "Please enter a product name") String name,
                                     @NotBlank(message = "Please enter a product description") String description,
